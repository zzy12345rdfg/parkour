...
public class zombies_tigger : MonoBehaviour
{
    float i = 5;
    ...
    public GameObject next_2;//进入下一关
    ...
    {      
        ...
        next_2.gameObject.SetActive(false);
    ...
    private void OnTriggerEnter(Collider other)
    {
        if (other.tag == "coin")
        {
            GameObject.Find("cion_audio").GetComponent<AudioSource>().Play();
    ...
    void Update()
    {
        ...
        grade_text.text = zombies_score.ToString();
